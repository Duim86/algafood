...
public class PedidoModelAssembler
  ...
  public PedidoModel toModel(Pedido pedido) {
    ...
    pedidoModel.add(linkTo(CozinhaController.class).withRel("cozinhas"));
    ...
    pedidoModel.getFormaPagamento().add(linkTo(methodOn(FormaDePagamentoController.class)
            .buscar(null, pedido.getFormaDePagamento().getId())).withSelfRel());
