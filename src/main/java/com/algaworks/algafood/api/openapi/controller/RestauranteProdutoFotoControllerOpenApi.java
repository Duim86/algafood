...
public interface RestauranteProdutoFotoControllerOpenApi {
  ...
  ResponseEntity<Object> servirFoto(Long restauranteId,
                                    Long produtoId,
  ...
  FotoProdutoModel atualizarFoto(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId,
                                 ...
                                 @ApiParam(hidden = true) MultipartFile arquivo) throws IOException;
  ...
  void excluir(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long restauranteId,
               @ApiParam(value = "ID do produto", example = "1", required = true) Long produtoId) throws IOException;
}
