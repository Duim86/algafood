...
public class AlgaLinks {
  ...
  public Link linkToFormaPagamento(Long formaDePagamentoId, String rel) {
    return linkTo(methodOn(FormaDePagamentoController.class)
            .buscar(null, formaDePagamentoId)).withRel(rel);
  }

  public Link linkToFormaPagamento(Long formaDePagamentoId) {
    return linkToFormaPagamento(formaDePagamentoId, IanaLinkRelations.SELF.value());
  }
  ...
  public Link linkToRestauranteFormaPagamentoDesassociacao(Long restauranteId, Long formaDePagamentoId, String rel){
    return linkTo(methodOn(RestauranteFormaPagamentoController.class).desassociar(restauranteId, formaDePagamentoId)).withRel(rel);
  }
