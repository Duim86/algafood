package com.algaworks.algafood.core.openapi.adapter;
...
public class TypeNameExtractorAdapter extends TypeNameExtractor {
  ...
  public TypeNameExtractorAdapter(TypeResolver typeResolver,
                                  PluginRegistry<TypeNameProviderPlugin,
                                          DocumentationType> typeNameProviders, EnumTypeDeterminer enumTypeDeterminer, TypeResolver typeResolver1, PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviders1, EnumTypeDeterminer enumTypeDeterminer1) {
